...
with open('../output/4a_lectures_prepared_for_sorting.json', 'r', encoding='utf-8') as file:
    data = json.load(file)
...
# Save final results
output_json = '../output/4b_lectures_with_order.json'
...
# Save Excel format
output_excel = '../output/4b_lectures_with_order.xlsx'
